...
_OPTIONAL_PROVIDERS = (
    ("cce.indexing.parser.languages.java_provider", "JavaProvider"),
    ("cce.indexing.parser.languages.csharp_provider", "CSharpProvider"),
    ("cce.indexing.parser.languages.go_provider", "GoProvider"),
)

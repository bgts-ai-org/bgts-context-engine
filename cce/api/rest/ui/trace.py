...
Replays the exact flow of :func:`cce.tools.layer3.orchestration.get_context_for_task` - same
...
Nothing outside ``cce.api.rest.ui`` is modified; core functions are only *called*.
"""
...
def _fast_to_candidates(repository: GraphRepository, expansion: dict) -> list[Candidate]:
    """Bulk-query equivalent of :func:`cce.core.orchestrator.expand.to_candidates`.

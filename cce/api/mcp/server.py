...
Binds the SDK-independent tool catalog (:mod:`cce.api.mcp.tools`) to a real MCP server. The ``mcp``
...
def build_server(name: str = "cortex-context-engine") -> Any:
    """Construct an MCP ``Server`` exposing every CCE tool. Requires the ``mcp`` package."""
    try:
...
async def run_stdio(name: str = "cortex-context-engine") -> None:  # pragma: no cover - SDK runtime

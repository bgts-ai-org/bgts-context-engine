...
Resolves the :class:`~bce.domain.models.UnresolvedRef` entries recorded by the language providers
...
from bce.indexing.linker.linker import link_fragments, synthesize_scip_edges
